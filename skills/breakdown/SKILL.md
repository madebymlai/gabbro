...
- **description**: Use the template at `${GABBRO_HOME}/resources/claude-execution-template.md`. Create a directory at `.gabbro/artifacts/breakdowns/<feature-name>/` with one self-contained document per build agent.
