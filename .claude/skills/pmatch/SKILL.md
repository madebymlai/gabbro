...
Ash and Ember are a sibling pair — both follow the shared playbook at `.claude/resources/prompts/pattern-match.md`. Ash runs natively in Claude Code; Ember proxies to an external model (Kimi) via Valence_ext.
